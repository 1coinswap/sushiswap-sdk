...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_TESTNET]: '0x3DD4406fE96b60550472C4c6bF82080DaC768bb6',
...
export const SUSHI_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FANTOM_TESTNET]: '',
  [ChainId.MATIC]: '',
  [ChainId.MATIC_TESTNET]: '0x018Ab914A816cfc36f2718500403B1DAb710ff4c',
  [ChainId.XDAI]: '',
...
export const MASTERCHEF_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FANTOM_TESTNET]: '',
  [ChainId.MATIC]: '',
  [ChainId.MATIC_TESTNET]: '0xb15C2dA3F3B61Fd6A775dc1d9f365f872C46DD1a',
  [ChainId.XDAI]: '',
